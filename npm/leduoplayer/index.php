...
<head>
    ...
    <link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/css/leduoplayer.css?1">
	<script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/jquery.min.js?1"></script>  
	<script>
	if (top === self) {  
	...
	<script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/des.js"></script> 
	<script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/layer.js?2322233311"></script>
    <script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/leduoplayer.js?a23331223463312111"></script>
    <script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/setting.js?a1002111"></script>     
	...
	$gvid=check($gvid);
    if (strpos($gvid, 'm3u8')) {
        echo '<script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/hls.min.js"></script>'; 
    } elseif (strpos($gvid, 'flv')) {
        echo '<script src="https://fastly.jsdelivr.net/gh/cdn-npm/npm/leduoplayer/js/flv.min.js"></script>'; 
    }
	$imgArr = array(
