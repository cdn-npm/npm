				...
				getDevtoolsDetail: function() {
					...
					function() {
						...
						function(i) {
							...
							case 4:
								if ((c = i.sent()).isOpen || c.directReturn) return e && (c.checkerName = e + "." + c.checkerName),
								[2, c];
								i.label = 5;
							case 5:
								return n++,
				...
				getDevtoolsDetail: function() {
					...
					function() {
						...
						function(n) {
							...
							case 1:
								return (e = n.sent()).directReturn = !0,
								[2, e]
							}
						})
					})
...
eval(function(p, a, c, k, e, r) {
	...
	return p
} ('(0(){1.addListener(0(2,detail){if(2 && IsPC()){3 4=self;3 5=4.location;5.href=decodeURIComponent(\'%2f\')}else{}});1.lanuch()})();', [], 6, 'function|devtoolsDetector|isOpen|const|_s|_l'.split('|'), 0, {}));